...
INSERT INTO client 
(dni,name,lastname,birthdate,email,address,phone) VALUES 
('85194743Y','Rika','Furude','2002-06-06','rika@nipah.com',ARRAY [Las Aguilar,Navarra,98740,Avinguda Domínquez 841 Bajo 4º],ARRAY ['673362328']);
-- 8
INSERT INTO client 
(dni,name,lastname,birthdate,email,address,phone) VALUES 
...
(dni,name,lastname,birthdate,email,address,phone) VALUES 
('76486423S','Zoro','Roronoa','2000-08-09','zoro@gmail.com','(Hidalgo de Ulla,Guadalajara,17279,Travesía Paola 610 Bajos)' ,ARRAY ['670362313']);
-- 2
INSERT INTO provider 
(dni,name,lastname,birthdate,email,address,phone) VALUES 
('88546101B','Hiluluk','','2000-04-05','hiluluk@gmail.com','(Villa Granado del Barco,Lleida,67279,Calle Olivares 982 9º 8º)' ,ARRAY ['610362323']);
-- 3
INSERT INTO provider 
(dni,name,lastname,birthdate,email,address,phone) VALUES 
('30818777L','Kinemon','Foxfire','2002-04-21','kinemon@gmail.com','(As Carrera,A Coruña,18126,Passeig Alicia 97 99º D)' ,ARRAY ['670312323']);
-- 4
INSERT INTO provider 
(dni,name,lastname,birthdate,email,address,phone) VALUES 
('38854476R','Rikka','Takarada','2004-11-24','rikka@gmail.com','(Corral del Puerto,Alicante,38979,Travesía Urrutia 95 13º C)' ,ARRAY ['670361323']);
-- 5
INSERT INTO provider 
(dni,name,lastname,birthdate,email,address,phone) VALUES 
('80983991W','Eren','Yeager','2004-07-07','eren@freedom.com','(La Montaño,Teruel,78914,Calle Jon 6 70º C)' ,ARRAY ['670362373']);
-- 6
INSERT INTO provider 
(dni,name,lastname,birthdate,email,address,phone) VALUES 
('87347317X','Naruto','Uzumaki','1999-11-16','norauto@gmail.com','(A Valles,Salamanca,38069,Paseo Valeria 980 0º E)' ,ARRAY ['670362329']);
-- 7
INSERT INTO provider 
(dni,name,lastname,birthdate,email,address,phone) VALUES 
('28437345F','Akane','Tsunemori','1998-11-27','akane@gmail.com','(San Rendón de Lemos,Cantabria,83544,Passeig María 325 Ático 4º)' ,ARRAY ['670362313']);
-- 8
INSERT INTO provider 
(dni,name,lastname,birthdate,email,address,phone) VALUES 
('49508076R','Gabriela','Méndez Tercero','1997-05-22','gabriela@gmail.com','(Os Valentín,Murcia,32705,Plaça Vera 53 06º E)' ,ARRAY ['670352323']);
-- 9
INSERT INTO provider 
(dni,name,lastname,birthdate,email,address,phone) VALUES 
('49294596F','Dario','Vicente','1997-01-15','dario@gmail.com','(La Delapaz de Lemos,Cádiz,61981,Plaza Baca 5 Bajos)' ,ARRAY ['650362323']);
-- 10
INSERT INTO provider 
(dni,name,lastname,birthdate,email,address,phone) VALUES 
('46763602W','Pablo','Abrego','1996-11-14','pablo@gmail.com','(Martos de Ulla,Cantabria,96384,Calle Rolón 97 8º 7º)' ,ARRAY ['670362328']);
